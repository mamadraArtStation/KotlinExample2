...
class RootActivity : AppCompatActivity() {
    ...
    private fun renderNotification(notification: Notify) {
        ...
        when(notification){
            ...
            is Notify.ActionMessage -> {
                ...
                snackbar.setAction(notification.actionLabel){
            ...
            is Notify.ErrorMessage -> {
                with(snackbar){
                    ...
                    setActionTextColor(getColor(android.R.color.white))
                        .setAction(notification.errLabel){
                            notification.errHandler?.invoke()
                        }
                }
            }
        }
    ...
    private fun setupBottombar() {
        ...
        btn_settings.setOnClickListener { viewModel.handleSetting() }
    }
    ...
    private fun renderUi(data: ArticleState) {
        ...
        if(data.categoryIcon!=null) toolbar.logo=ContextCompat.getDrawable(this,data.categoryIcon as Int)
    }
    ...
    private fun setupToolbar() {
        ...
        (logo?.layoutParams as LayoutParams)?.let{
